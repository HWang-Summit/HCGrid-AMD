...
map_size = 0
try:
    opts, args = getopt.getopt(sys.argv[1:], 'hp:i:t:n:m:s:b:',
                               ['path=', 'input=', 'target=', 'num=', 'map=', 'sample=', 'beam='])
except getopt.GetoptError:
    print(
        'python Create_input_file.py -p <absolute path> -i <inputfile> -t <targetfile> -n <number> -m <map size> -s <number samples> -b <beam size>')
    print(
