    ...
    while((pcl = getopt_long_only (argc, argv, "hp:i:t:o:s:n:b:d:a:r:m:f:", long_options, \
        ...
        switch(pcl){
            case 'h':
                ...
                "--sorted_file <sorted file> --output_file <output file> --fits_id <number> --beam_size <beam> --order_arg <order> --block_num <num>  --coarsening_factor<factor> \n");
                return 1;
            case 'p':
                path = optarg;
                break;
